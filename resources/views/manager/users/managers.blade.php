...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
              ...
              <div class="col-12">
                <div class="card card-olive card-outline">
                  <div class="card-header">
                    <h3 class="card-title"><span class="fas fa-users fa-sm text-olive me-1"></span>Résponsables</h3>
                    <div class="card-tools">
                      <button type="button" class="btn btn-sm bg-olive" data-bs-toggle="modal" data-bs-target="#mdNewManager">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table id="datatables" class="table table-bordered">
                      ...
                      <tbody>
                        @php
                          $Users = DB::table('hs_users')->where(['WorkJob' => 'Manager', 'Status' => 'ACTIF'])->orderBy('TimeOfRegister')->get();
                        @endphp
    ...
    <div class="modal fade" id="mdNewManager">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Créer un résponsable</h4>
          ...
          <div class="modal-body">
            ...
            <form class="row g-2">
              ...
              <div class="col-6">
                  ...
                  <input type="hidden" value="Manager" id="userRegisterWorkJob">
                  <input type="text" class="form-control" value="Résponsable" readonly>
              </div>

              <div class="col-6">
                  <label class="form-label">Position <span class="text-danger">*</span></label>
                  <select class="form-control select2picker" data-size="5" data-live-search="true" id="userRegisterWorkFunction">
                    <option value="10">Responsable Import-Export</option>
                    <option value="26">Responsable R&D</option>
                    <option value="7">Chef d'équipe</option>
                    <option value="33">Responsable Approvisionnement</option>
                    <option value="8">Responsable Production</option>
                    <option value="21">Chef Comptable</option>
                    <option value="17">Responsable Trésorerie</option>
                    <option value="45">Responsable Achats Technique et Emballages</option>
                    <option value="29">Responsable Systèmes d'Information</option>
                    <option value="15">Responsable Administratif et Financier</option>
                    <option value="43">Responsable QHSE</option>
                    <option value="34">Responsable Planification et Logistique</option>
                    <option value="2">Chef Technicien Supérieur</option>
                    <option value="12">Responsable Achats Thés</option>
                    <option value="14">Responsable ADV</option>
                    <option value="37">Chef Chargé Dépôt</option>
                  </select>
              </div>
